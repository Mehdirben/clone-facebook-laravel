    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="md:col-span-1">
                    <div class="bg-white rounded-lg shadow p-4 mb-6">
                        ...
                        <nav class="space-y-2">
                            ...
                            <a href="{{ route('posts.index') }}" class="flex items-center text-gray-800 hover:bg-gray-100 p-2 rounded-lg {{ Route::currentRouteName() === 'posts.create' ? 'bg-gray-100' : '' }}">
                ...
                <!-- Colonne centrale (Formulaire de création) -->
                <div class="md:col-span-2">
                    <div class="bg-white shadow rounded-lg p-6">
                        <h3 class="text-lg font-semibold mb-4">Créer une nouvelle publication</h3>
                        ...
                        <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea id="content" name="content" rows="6" class="w-full rounded-lg border border-gray-300 p-3 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent" placeholder="Que voulez-vous partager?">{{ old('content') }}</textarea>
                            </div>
                            ...
                            <div class="mb-6">
                                <label class="flex items-center">
                                    <input type="checkbox" name="is_public" value="1" {{ old('is_public', true) ? 'checked' : '' }} class="mr-2 focus:ring-blue-500 h-4 w-4 text-blue-600 border-gray-300 rounded">
                            ...
                            <div class="flex justify-end">
                                <a href="{{ route('posts.index') }}" class="bg-gray-300 text-gray-800 px-4 py-2 rounded-lg hover:bg-gray-400 mr-2">
                                    Annuler
                                </a>
