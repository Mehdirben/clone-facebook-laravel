                ...
                <div class="md:col-span-1">
                    <div class="bg-white rounded-lg shadow p-4 mb-6">
                        ...
                        <nav class="space-y-2">
                            ...
                            <a href="{{ route('posts.index') }}" class="flex items-center text-gray-800 hover:bg-gray-100 p-2 rounded-lg {{ Route::currentRouteName() === 'posts.index' ? 'bg-gray-100' : '' }}">
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="bg-white shadow rounded-lg mb-6 p-4">
                        <div class="flex justify-between items-center">
                            <h3 class="text-lg font-semibold">Mes publications</h3>
                            <a href="{{ route('posts.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700">
                                <i class="fas fa-plus mr-1"></i> Nouvelle publication
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="space-y-6">
                        ...
                        @empty
                            <div class="bg-white rounded-lg shadow p-6 text-center">
                                <p class="text-gray-500">Vous n'avez pas encore créé de publications.</p>
                                <div class="mt-4">
                                    <a href="{{ route('posts.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700">
